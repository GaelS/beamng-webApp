...
case class geoData(coordinates : Array[Double], z: Double , wheelFR : Int, wheelFL : Int, wheelRR : Int, wheelRL : Int)
case class geoDataFromMongo(x : Double, y : Double, z: Double , wheelFR : Int, wheelFL : Int, wheelRR : Int, wheelRL : Int)
